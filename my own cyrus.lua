...
local BulletColour = ColorSequence.new(Color3.fromRGB(012.061,061))
local EspColour = Color3.fromRGB(012.061,061)
...
local function IsAUser(Player,Chat)
	if Chat == "COVAX REMAKE CYRUS" or Chat == "YOOOOOOO" then 
...
local function createRainbow(Pos,Text,Value)
	...
	RainbowButton.BackgroundColor3 = Color3.fromRGB(136, 0, 255)
	...
	RainbowButton.TextColor3 = Color3.fromRGB(12.61,61)
...
local function createCommandBarCmd(Name,Args)
	if Name and Args then 
		...
		CmdBarTextLabel.TextColor3 = Color3.fromRGB(136, 0, 255)
...
local function createCmd(Pos,CommandName,CommandInfo,CommandArgs)
	...
	CommandLabel.TextColor3 = Color3.fromRGB(12,61,61)
...
privateProperties = { --customize private logs
 ...
 if game.PlaceId == 10046946702 then
...
end,"spy",{"syp"},"see peoples whisper")
...
coroutine.resume(coroutine.create(function()
	...
	CmdsLabel.BackgroundColor3 = Color3.fromRGB(30, 0, 255)
	...
	CmdsLabel.TextColor3 = Color3.fromRGB(136,0,255)
	...
	ValuesFrame.BackgroundColor3 = Color3.fromRGB(136,0,255)
	...
	ValuesTextLabel.BackgroundColor3 = Color3.fromRGB(85, 0, 127)
	...
	ValuesTextLabel.TextColor3 = Color3.fromRGB(136,0,255)
	...
	HotkeysFrame.BackgroundColor3 = Color3.fromRGB(30, 0, 255)
	...
	HotkeysTextLabel.BackgroundColor3 = Color3.fromRGB(136,0,255)
	HotkeysTextLabel.BackgroundTransparency = 0.6
	HotkeysTextLabel.BorderColor3 = Color3.fromRGB(85, 0, 127)
